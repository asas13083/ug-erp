...
Object.assign(translations, {
  ...
  'موزّعة على': { en: 'Allocated to' },
  'دفعة عامة': { en: 'General payment' },
  'وزّع المبلغ على الفواتير': { en: 'Distribute amount across invoices' },
  'توزيع تلقائي': { en: 'Auto-distribute' },
  'متبقّي': { en: 'Remaining' },
  'الموزّع': { en: 'Allocated' },
  'غير موزّع (دفعة عامة)': { en: 'Unallocated (general)' },
  'زيادة عن الدفعة': { en: 'Exceeds payment' },
  'مجموع الموزّع على الفواتير أكبر من قيمة الدفعة': { en: 'Total allocated exceeds the payment amount' },
  'عامة': { en: 'General' },
  ...
  'عرض الفواتير': { en: 'Show invoices' },
  'فاتورة': { en: 'Invoice' },
  'مورد': { en: 'Supplier' },
  'عليه': { en: 'Owed' },
  'متبقي': { en: 'Remaining' },
  'إخفاء': { en: 'Hide' },
  'مديونية الموردين': { en: 'Suppliers debt' },
  'إجمالي مديونية الموردين في الحفلة دي': { en: 'Total suppliers debt for this event' },
  'إجمالي فواتير الموردين': { en: 'Total suppliers invoices' },
  'إجمالي مديونية الموردين لكل الحفلات المعروضة': { en: 'Total suppliers debt across shown events' },
  'إجمالي مديونية الموردين لكل الحفلات': { en: 'Total suppliers debt across all events' },
  'اختياري': { en: 'Optional' },
  'الشعار': { en: 'Logo' },
  'عدد الحفلات (لسه برا)': { en: 'Events still out in' },
  'الوجهة': { en: 'Destination' },
  'سعر الوحدة': { en: 'Unit price' },
  'مدفوع': { en: 'Paid' },
