...
ALTER TABLE "event_supplier_entry_lines" ADD CONSTRAINT "event_supplier_entry_lines_entryId_fkey" FOREIGN KEY ("entryId") REFERENCES "event_supplier_entries"("id") ON DELETE CASCADE ON UPDATE CASCADE;
