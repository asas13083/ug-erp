/*
  ...
  - The values [RETURN_PENDING] on the enum `EventStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "EventStatus_new" AS ENUM ('PLANNED', 'ONGOING', 'CLOSED', 'CANCELLED');
...
-- AlterTable
ALTER TABLE "email_queue" ADD COLUMN     "reportDate" TEXT,
